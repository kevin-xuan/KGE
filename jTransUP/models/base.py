...
def get_flags():
    ...
    gflags.DEFINE_integer("num_processes", 4, ".")  # default: 4  什么意思？
    ...
    gflags.DEFINE_integer("batch_size", 64, "Minibatch size.")  # 512
    ...
    gflags.DEFINE_integer("seed", 3, "Fix the random seed. Except for 0, which means no setting of random seed.")  # 0
    gflags.DEFINE_integer("topn", 10, "")
    gflags.DEFINE_integer("num_preferences", 4, "")  # 有用吗？
